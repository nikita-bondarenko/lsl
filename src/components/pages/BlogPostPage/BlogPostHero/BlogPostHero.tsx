    ...
    return (
        <div className={stack('container-new', styles.body, 'section-indent-new')}>
            <Link to={'/blog'} className={styles.link}>
                <svg className={styles.link__arrow} xmlns="http://www.w3.org/2000/svg" width="8" height="12" viewBox="0 0 8 12" fill="none">
                    <path d="M5.98022 11.7602L0.220215 6.00023L5.98022 0.240234L7.78021 2.02823L3.67621 6.00023L7.78021 9.97223L5.98022 11.7602Z" fill="black"/>
                </svg>
                Назад</Link>
            ...
            <div className={stack(styles.content)}>
                <h1 className={styles.title}>{blogPostPage.blog.blogPostHeroZagolovok}</h1>
            </div>
        </div>
    );
};
