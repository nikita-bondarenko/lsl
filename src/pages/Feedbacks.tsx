...
const Feedbacks = () => {
    ...
    return (
        <Layout>
            <div className="mt-[91px] 2xl:mt-[70px]
xl:mt-[52px] lg:mt-[50px] md:mt-[37px] sm:mt-[7px]">
            ...
            <Publications className="2xl:mb-[120px] xl:mb-[75px] lg:mb-[66px] md:mb-[43px] sm:mb-[40px]"></Publications>
            <Messenger className="mb-[130px] 2xl:mb-[121px] xl:mb-[18px] lg:mb-[10px] md:mb-[-12px]"></Messenger>
        </Layout>
    );
};
