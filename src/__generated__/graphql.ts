...
/** The Blog type */
export type Blog = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithFeaturedImage & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & {
  __typename?: 'Blog';
  /** Added to the GraphQL Schema because the ACF Field Group &quot;Запись для блога&quot; was set to Show in GraphQL. */
  blog?: Maybe<Blog_Blog>;
  /**
...
/** Field Group */
export type Blog_Blog = AcfFieldGroup & {
  __typename?: 'Blog_Blog';
  blogPostImageKompyuter1x?: Maybe<MediaItem>;
  blogPostImageKompyuter2x?: Maybe<MediaItem>;
  blogPostImageTelefon1x?: Maybe<MediaItem>;
  blogPostImageTelefon2x?: Maybe<MediaItem>;
  blogPostTekst?: Maybe<Scalars['String']>;
  blogPostZagolovok?: Maybe<Scalars['String']>;
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']>;
};
...
/** The CommonSection type */
export type CommonSection = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithFeaturedImage & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & {
  __typename?: 'CommonSection';
  /**
   * The id field matches the WP_Post-&gt;ID field.
   * @deprecated Deprecated in favor of the databaseId field
   */
  commonSectionId: Scalars['Int'];
  /** The content of the post. */
  content?: Maybe<Scalars['String']>;
  /** Connection between the ContentNode type and the ContentType type */
  contentType?: Maybe<ContentNodeToContentTypeConnectionEdge>;
  /** The name of the Content Type the node belongs to */
  contentTypeName: Scalars['String'];
  /** Added to the GraphQL Schema because the ACF Field Group &quot;Cookies&quot; was set to Show in GraphQL. */
  cookies?: Maybe<CommonSection_Cookies>;
  /** The unique identifier stored in the database */
  databaseId: Scalars['Int'];
  /** Post publishing date. */
  date?: Maybe<Scalars['String']>;
  ...
  /** Globally unique ID of the featured image assigned to the node */
  featuredImageId?: Maybe<Scalars['ID']>;
  /** Added to the GraphQL Schema because the ACF Field Group &quot;Отзывы&quot; was set to Show in GraphQL. */
  feedbacks?: Maybe<CommonSection_Feedbacks>;
  /** Added to the GraphQL Schema because the ACF Field Group &quot;Подвал&quot; was set to Show in GraphQL. */
  footer?: Maybe<CommonSection_Footer>;
  /** The global unique identifier for this post. This currently matches the value stored in WP_Post-&gt;guid and the guid column in the &quot;post_objects&quot; database table. */
  guid?: Maybe<Scalars['String']>;
  /** Added to the GraphQL Schema because the ACF Field Group &quot;Шапка&quot; was set to Show in GraphQL. */
  header?: Maybe<CommonSection_Header>;
  /** The globally unique identifier of the common_section object. */
  id: Scalars['ID'];
  /** Whether the node is a Content Node */
  isContentNode: Scalars['Boolean'];
  /** Whether the object is a node in the preview state */
  ...
  /** The permalink of the post */
  link?: Maybe<Scalars['String']>;
  /** Added to the GraphQL Schema because the ACF Field Group &quot;Мессенджер&quot; was set to Show in GraphQL. */
  messenger?: Maybe<CommonSection_Messenger>;
  /** The local modified time for a post. If a post was recently updated the modified field will change to match the corresponding time. */
  modified?: Maybe<Scalars['String']>;
  /** The GMT modified time for a post. If a post was recently updated the modified field will change to match the corresponding time in GMT. */
  modifiedGmt?: Maybe<Scalars['String']>;
  /** Added to the GraphQL Schema because the ACF Field Group &quot;Как оформить заказ&quot; was set to Show in GraphQL. */
  orderSteps?: Maybe<CommonSection_Ordersteps>;
  /** Connection between the CommonSection type and the CommonSection type */
  preview?: Maybe<CommonSectionToPreviewConnectionEdge>;
  /** The database id of the preview node */
  previewRevisionDatabaseId?: Maybe<Scalars['Int']>;
  /** Whether the object is a node in the preview state */
  previewRevisionId?: Maybe<Scalars['ID']>;
...
/** The CommonSection type */
export type CommonSectionContentArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};


/** The CommonSection type */
export type CommonSectionEnqueuedScriptsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
/** The CommonSection type */
export type CommonSectionEnqueuedStylesheetsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
/** The CommonSection type */
export type CommonSectionTitleArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};

/** Connection to CommonSection Nodes */
export type CommonSectionConnection = {
  /** A list of edges (relational context) between RootQuery and connected CommonSection Nodes */
  edges: Array<CommonSectionConnectionEdge>;
  /** A list of connected CommonSection Nodes */
  nodes: Array<CommonSection>;
  /** Information about pagination in a connection. */
  pageInfo: CommonSectionConnectionPageInfo;
};

/** Edge between a Node and a connected CommonSection */
export type CommonSectionConnectionEdge = {
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']>;
  /** The connected CommonSection Node */
  node: CommonSection;
};

/** Page Info on the connected CommonSectionConnectionEdge */
export type CommonSectionConnectionPageInfo = {
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean'];
...
/** The Type of Identifier used to fetch a single resource. Default is ID. */
export enum CommonSectionIdType {
  /** Identify a resource by the Database ID. */
  DatabaseId = 'DATABASE_ID',
  /** Identify a resource by the (hashed) Global ID. */
  Id = 'ID',
...
/** Connection between the CommonSection type and the CommonSection type */
export type CommonSectionToPreviewConnectionEdge = CommonSectionConnectionEdge & Edge & OneToOneConnection & {
  __typename?: 'CommonSectionToPreviewConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']>;
  /** The node of the connection, without the edges */
  node: CommonSection;
...
/** Field Group */
export type CommonSection_Cookies = AcfFieldGroup & {
  __typename?: 'CommonSection_Cookies';
  cookiesPolitikaKonfidenczialnosti?: Maybe<MediaItem>;
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']>;
};

/** Field Group */
export type CommonSection_Feedbacks = AcfFieldGroup & {
  __typename?: 'CommonSection_Feedbacks';
  feedbacksImageSlajder?: Maybe<Array<Maybe<CommonSection_Feedbacks_FeedbacksImageSlajder>>>;
  feedbacksPodzagolovok?: Maybe<Scalars['String']>;
  feedbacksSimpleSlajder?: Maybe<Array<Maybe<CommonSection_Feedbacks_FeedbacksSimpleSlajder>>>;
  feedbacksZagolovok?: Maybe<Scalars['String']>;
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']>;
};

/** Field Group */
export type CommonSection_Feedbacks_FeedbacksImageSlajder = AcfFieldGroup & {
  __typename?: 'CommonSection_Feedbacks_feedbacksImageSlajder';
  feedbacksImageKompyuter1x?: Maybe<MediaItem>;
  feedbacksImageKompyuter2x?: Maybe<MediaItem>;
  feedbacksImageTelefon1x?: Maybe<MediaItem>;
  feedbacksImageTelefon2x?: Maybe<MediaItem>;
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']>;
};

/** Field Group */
export type CommonSection_Feedbacks_FeedbacksSimpleSlajder = AcfFieldGroup & {
  __typename?: 'CommonSection_Feedbacks_feedbacksSimpleSlajder';
  feedbacksSimpleImya?: Maybe<Scalars['String']>;
  feedbacksSimpleKompyuter1x?: Maybe<MediaItem>;
  feedbacksSimpleKompyuter2x?: Maybe<MediaItem>;
  feedbacksSimpleOpisanieKlienta?: Maybe<Scalars['String']>;
  feedbacksSimpleTekstOtzyva?: Maybe<Scalars['String']>;
  feedbacksSimpleTelefon1x?: Maybe<MediaItem>;
  feedbacksSimpleTelefon2x?: Maybe<MediaItem>;
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']>;
};

/** Field Group */
export type CommonSection_Footer = AcfFieldGroup & {
  __typename?: 'CommonSection_Footer';
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']>;
  footerAdresSajta?: Maybe<Scalars['String']>;
  footerContactsSpisok?: Maybe<Array<Maybe<CommonSection_Footer_FooterContactsSpisok>>>;
  footerKopirajt?: Maybe<Scalars['String']>;
  footerLogotip?: Maybe<MediaItem>;
  footerLogotipMobile?: Maybe<MediaItem>;
  footerPolitikaKonfidenczialnosti?: Maybe<MediaItem>;
  footerPublichnayaOferta?: Maybe<MediaItem>;
  footerSocialSpisok?: Maybe<Array<Maybe<CommonSection_Footer_FooterSocialSpisok>>>;
  footerSocialZagolovok?: Maybe<Scalars['String']>;
  remarka?: Maybe<Scalars['String']>;
  zagolovok?: Maybe<Scalars['String']>;
};

/** Field Group */
export type CommonSection_Footer_FooterContactsSpisok = AcfFieldGroup & {
  __typename?: 'CommonSection_Footer_footerContactsSpisok';
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']>;
  footerContactsEstKommentarij?: Maybe<Scalars['String']>;
  footerContactsHref?: Maybe<Scalars['String']>;
  footerContactsKommentarij?: Maybe<Scalars['String']>;
  footerContactsTekst?: Maybe<Scalars['String']>;
};

/** Field Group */
export type CommonSection_Footer_FooterSocialSpisok = AcfFieldGroup & {
  __typename?: 'CommonSection_Footer_footerSocialSpisok';
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']>;
  footerSocialAdres?: Maybe<Scalars['String']>;
  footerSocialIkonka?: Maybe<MediaItem>;
  footerSocialTekst?: Maybe<Scalars['String']>;
};

/** Field Group */
export type CommonSection_Header = AcfFieldGroup & {
  __typename?: 'CommonSection_Header';
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']>;
  headerAdresSajta?: Maybe<Scalars['String']>;
  headerLogotip?: Maybe<MediaItem>;
  headerLogotipMobile?: Maybe<MediaItem>;
  headerTelefon?: Maybe<Scalars['String']>;
};

/** Field Group */
export type CommonSection_Messenger = AcfFieldGroup & {
  __typename?: 'CommonSection_Messenger';
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']>;
  messengerImageKompyuter1x?: Maybe<MediaItem>;
  messengerImageKompyuter2x?: Maybe<MediaItem>;
  messengerImageTelefon1x?: Maybe<MediaItem>;
  messengerImageTelefon2x?: Maybe<MediaItem>;
  messengerPodzagolovok?: Maybe<Scalars['String']>;
  messengerSsylkaKnopki?: Maybe<Scalars['String']>;
  messengerTekstKnopki?: Maybe<Scalars['String']>;
  messengerZagolovok?: Maybe<Scalars['String']>;
};

/** Field Group */
export type CommonSection_Ordersteps = AcfFieldGroup & {
  __typename?: 'CommonSection_Ordersteps';
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']>;
  spisok?: Maybe<Array<Maybe<CommonSection_Ordersteps_Spisok>>>;
  zagolovok?: Maybe<Scalars['String']>;
};

/** Field Group */
export type CommonSection_Ordersteps_Spisok = AcfFieldGroup & {
  __typename?: 'CommonSection_Ordersteps_spisok';
  adresSsylki?: Maybe<Scalars['String']>;
  estLiSsylkaVTekste?: Maybe<Scalars['String']>;
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']>;
  nomer?: Maybe<Scalars['String']>;
  tekst?: Maybe<Scalars['String']>;
  tekstSsylki?: Maybe<Scalars['String']>;
};
...
/** Input for the createCommonSection mutation. */
export type CreateCommonSectionInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']>;
  /** The content of the object */
  content?: InputMaybe<Scalars['String']>;
...
/** The payload for the createCommonSection mutation. */
export type CreateCommonSectionPayload = {
  __typename?: 'CreateCommonSectionPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']>;
  /** The Post object mutation type. */
  commonSection?: Maybe<CommonSection>;
};
...
/** Input for the createPublication mutation. */
...
/** The payload for the createPublication mutation. */
...
/** Input for the createTraining mutation. */
...
/** The payload for the createTraining mutation. */
export type CreateTrainingPayload = {
  __typename?: 'CreateTrainingPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']>;
  /** The Post object mutation type. */
...
/** Input for the deleteCommonSection mutation. */
export type DeleteCommonSectionInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']>;
  /** Whether the object should be force deleted instead of being moved to the trash */
  forceDelete?: InputMaybe<Scalars['Boolean']>;
  /** The ID of the CommonSection to delete */
  id: Scalars['ID'];
  /** Override the edit lock when another user is editing the post */
  ignoreEditLock?: InputMaybe<Scalars['Boolean']>;
};

/** The payload for the deleteCommonSection mutation. */
export type DeleteCommonSectionPayload = {
  __typename?: 'DeleteCommonSectionPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']>;
  /** The object before it was deleted */
  commonSection?: Maybe<CommonSection>;
...
/** Input for the deletePublication mutation. */
...
/** The payload for the deletePublication mutation. */
...
/** Input for the deleteTraining mutation. */
...
/** The payload for the deleteTraining mutation. */
export type DeleteTrainingPayload = {
  __typename?: 'DeleteTrainingPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']>;
  /** The ID of the deleted object */
  deletedId?: Maybe<Scalars['ID']>;
...
export type MenuItemObjectUnion = Blog | Category | CommonSection | Page | Post | PostFormat | Publication | Tag | Training;
...
export type Page = ContentNode & DatabaseIdentifier & HierarchicalContentNode & HierarchicalNode & MenuItemLinkable & Node & NodeWithAuthor & NodeWithComments & NodeWithContentEditor & NodeWithFeaturedImage & NodeWithPageAttributes & NodeWithRevisions & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & {
  ...
  /** The permalink of the post */
  link?: Maybe<Scalars['String']>;
  /** Added to the GraphQL Schema because the ACF Field Group &quot;Главная&quot; was set to Show in GraphQL. */
  main?: Maybe<Page_Main>;
  /** A field used for ordering posts. This is typically used with nav menu items or for special ordering of hierarchical content types. */
  menuOrder?: Maybe<Scalars['Int']>;
  /** The local modified time for a post. If a post was recently updated the modified field will change to match the corresponding time. */
  modified?: Maybe<Scalars['String']>;
...
/** Field Group */
export type Page_Main = AcfFieldGroup & {
  __typename?: 'Page_Main';
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']>;
  mainAboutImageKompyuter1x?: Maybe<MediaItem>;
  mainAboutImageKompyuter2x?: Maybe<MediaItem>;
  mainAboutImageTelefon1x?: Maybe<MediaItem>;
  mainAboutImageTelefon2x?: Maybe<MediaItem>;
  mainAboutTekst?: Maybe<Scalars['String']>;
  mainAboutZagolovok?: Maybe<Scalars['String']>;
  mainBlogAdresSsylki?: Maybe<Scalars['String']>;
  mainBlogRemarka?: Maybe<Scalars['String']>;
  mainBlogTekstSsylki?: Maybe<Scalars['String']>;
  mainBlogZagolovok?: Maybe<Scalars['String']>;
  mainHeroAdresSsylki?: Maybe<Scalars['String']>;
  mainHeroMalyjTekst?: Maybe<Scalars['String']>;
  mainHeroPodzagolovok?: Maybe<Scalars['String']>;
  mainHeroSlajder?: Maybe<Array<Maybe<Page_Main_MainHeroSlajder>>>;
  mainHeroTekst?: Maybe<Scalars['String']>;
  mainHeroTekstSsylki?: Maybe<Scalars['String']>;
  mainHeroZagolovok?: Maybe<Scalars['String']>;
  mainSafetyPervyjTekst?: Maybe<Scalars['String']>;
  mainSafetyVideo?: Maybe<Scalars['String']>;
  mainSafetyVtorojTekst?: Maybe<Scalars['String']>;
  mainSafetyZagolovok?: Maybe<Scalars['String']>;
  mainSupportRemarka?: Maybe<Scalars['String']>;
  mainSupportRemarkaVnizu?: Maybe<Scalars['String']>;
  mainSupportSpisokVozmozhnyhPozhertvovanij?: Maybe<Array<Maybe<Page_Main_MainSupportSpisokVozmozhnyhPozhertvovanij>>>;
  mainSupportTekst?: Maybe<Scalars['String']>;
  mainSupportTekstKnopki?: Maybe<Scalars['String']>;
  mainSupportZagolovok?: Maybe<Scalars['String']>;
  mainTrainingAdresSsylki?: Maybe<Scalars['String']>;
  mainTrainingTekstSsylki?: Maybe<Scalars['String']>;
  mainTrainingZagolovok?: Maybe<Scalars['String']>;
  mainValuesSpisok?: Maybe<Array<Maybe<Page_Main_MainValuesSpisok>>>;
  mainValuesZagolovok?: Maybe<Scalars['String']>;
};

/** Field Group */
export type Page_Main_MainHeroSlajder = AcfFieldGroup & {
  __typename?: 'Page_Main_mainHeroSlajder';
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']>;
  mainHeroSlajderKompyuter1x?: Maybe<MediaItem>;
  mainHeroSlajderKompyuter2x?: Maybe<MediaItem>;
  mainHeroSlajderTelefon1x?: Maybe<MediaItem>;
  mainHeroSlajderTelefon2x?: Maybe<MediaItem>;
};

/** Field Group */
export type Page_Main_MainSupportSpisokVozmozhnyhPozhertvovanij = AcfFieldGroup & {
  __typename?: 'Page_Main_mainSupportSpisokVozmozhnyhPozhertvovanij';
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']>;
  mainSupportSpisokSumma?: Maybe<Scalars['Float']>;
};

/** Field Group */
export type Page_Main_MainValuesSpisok = AcfFieldGroup & {
  __typename?: 'Page_Main_mainValuesSpisok';
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']>;
  mainValuesNomer?: Maybe<Scalars['String']>;
  mainValuesTekst?: Maybe<Scalars['String']>;
};
...
export type Publication = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithFeaturedImage & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & {
  ...
  /** The global unique identifier for this post. This currently matches the value stored in WP_Post-&gt;guid and the guid column in the &quot;post_objects&quot; database table. */
  guid?: Maybe<Scalars['String']>;
  /** The globally unique identifier of the publications object. */
  id: Scalars['ID'];
  /** Whether the node is a Content Node */
  isContentNode: Scalars['Boolean'];
  /** Whether the object is a node in the preview state */
  ...
  /** The GMT modified time for a post. If a post was recently updated the modified field will change to match the corresponding time in GMT. */
  modifiedGmt?: Maybe<Scalars['String']>;
  /** Connection between the Publication type and the Publication type */
  preview?: Maybe<PublicationToPreviewConnectionEdge>;
  /** The database id of the preview node */
  previewRevisionDatabaseId?: Maybe<Scalars['Int']>;
  /** Whether the object is a node in the preview state */
  previewRevisionId?: Maybe<Scalars['ID']>;
  ...
  /** Added to the GraphQL Schema because the ACF Field Group &quot;Публикация&quot; was set to Show in GraphQL. */
  publications?: Maybe<Publication_Publications>;
  /** The uri slug for the post. This is equivalent to the WP_Post-&gt;post_name field and the post_name column in the database for the &quot;post_objects&quot; table. */
  slug?: Maybe<Scalars['String']>;
  /** The current status of the object */
  status?: Maybe<Scalars['String']>;
...
/** The Publication type */
export type PublicationContentArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};


/** The Publication type */
export type PublicationEnqueuedScriptsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
/** The Publication type */
export type PublicationEnqueuedStylesheetsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
/** Connection to Publication Nodes */
export type PublicationConnection = {
  /** A list of edges (relational context) between RootQuery and connected Publication Nodes */
  edges: Array<PublicationConnectionEdge>;
  /** A list of connected Publication Nodes */
  nodes: Array<Publication>;
  /** Information about pagination in a connection. */
  pageInfo: PublicationConnectionPageInfo;
};

/** Edge between a Node and a connected Publication */
export type PublicationConnectionEdge = {
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']>;
  /** The connected Publication Node */
  node: Publication;
};

/** Page Info on the connected PublicationConnectionEdge */
export type PublicationConnectionPageInfo = {
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean'];
...
/** Connection between the Publication type and the Publication type */
export type PublicationToPreviewConnectionEdge = Edge & OneToOneConnection & PublicationConnectionEdge & {
  __typename?: 'PublicationToPreviewConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']>;
  /** The node of the connection, without the edges */
  node: Publication;
...
/** Field Group */
export type Publication_Publications = AcfFieldGroup & {
  __typename?: 'Publication_Publications';
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']>;
  publicationsAdresSsylki?: Maybe<Scalars['String']>;
  publicationsImageKompyuter1x?: Maybe<MediaItem>;
  publicationsImageKompyuter2x?: Maybe<MediaItem>;
  publicationsImageTelefon1x?: Maybe<MediaItem>;
  publicationsImageTelefon2x?: Maybe<MediaItem>;
  publicationsKratkoeOpisanie?: Maybe<Scalars['String']>;
  publicationsNazvanie?: Maybe<Scalars['String']>;
  publicationsPodrobnoeOpisanie?: Maybe<Scalars['String']>;
};
...
export type RootMutation = {
  ...
  /** The createCommonSection mutation */
  createCommonSection?: Maybe<CreateCommonSectionPayload>;
  ...
  /** The deleteCommonSection mutation */
  deleteCommonSection?: Maybe<DeleteCommonSectionPayload>;
  ...
  /** The updateCommonSection mutation */
  updateCommonSection?: Maybe<UpdateCommonSectionPayload>;
...
/** The root mutation */
export type RootMutationCreateCommonSectionArgs = {
  input: CreateCommonSectionInput;
};
...
/** The root mutation */
export type RootMutationCreatePublicationArgs = {
...
/** The root mutation */
export type RootMutationCreateTrainingArgs = {
...
/** The root mutation */
export type RootMutationDeleteCommonSectionArgs = {
  input: DeleteCommonSectionInput;
};
...
/** The root mutation */
export type RootMutationDeletePublicationArgs = {
...
/** The root mutation */
export type RootMutationDeleteTrainingArgs = {
...
/** The root mutation */
export type RootMutationUpdateCommonSectionArgs = {
  input: UpdateCommonSectionInput;
};
...
/** The root mutation */
export type RootMutationUpdatePublicationArgs = {
...
/** The root mutation */
export type RootMutationUpdateTrainingArgs = {
...
export type RootQuery = {
  ...
  /** An object of the CommonSection Type.  */
  commonSection?: Maybe<CommonSection>;
  /**
   * A CommonSection object
   * @deprecated Deprecated in favor of using the single entry point for this type with ID and IDType fields. For example, instead of postBy( id: &quot;&quot; ), use post(id: &quot;&quot; idType: &quot;&quot;)
   */
  commonSectionBy?: Maybe<CommonSection>;
  /** Connection between the RootQuery type and the CommonSection type */
  commonSections?: Maybe<RootQueryToCommonSectionConnection>;
  ...
  /** An object of the Publication Type.  */
  publication?: Maybe<Publication>;
  /**
   * A Publication object
   * @deprecated Deprecated in favor of using the single entry point for this type with ID and IDType fields. For example, instead of postBy( id: &quot;&quot; ), use post(id: &quot;&quot; idType: &quot;&quot;)
   */
  publicationBy?: Maybe<Publication>;
  /** Connection between the RootQuery type and the Publication type */
  publications?: Maybe<RootQueryToPublicationConnection>;
  ...
  /** An object of the Training Type.  */
  training?: Maybe<Training>;
  /**
   * A Training object
   * @deprecated Deprecated in favor of using the single entry point for this type with ID and IDType fields. For example, instead of postBy( id: &quot;&quot; ), use post(id: &quot;&quot; idType: &quot;&quot;)
   */
  trainingBy?: Maybe<Training>;
  /** Connection between the RootQuery type and the Training type */
  trainings?: Maybe<RootQueryToTrainingConnection>;
  /** Returns a user */
  user?: Maybe<User>;
  /** Returns a user role */
...
/** The root entry point into the Graph */
export type RootQueryCommonSectionArgs = {
  asPreview?: InputMaybe<Scalars['Boolean']>;
  id: Scalars['ID'];
  idType?: InputMaybe<CommonSectionIdType>;
};


/** The root entry point into the Graph */
export type RootQueryCommonSectionByArgs = {
  commonSectionId?: InputMaybe<Scalars['Int']>;
  id?: InputMaybe<Scalars['ID']>;
  slug?: InputMaybe<Scalars['String']>;
  uri?: InputMaybe<Scalars['String']>;
};
...
/** The root entry point into the Graph */
export type RootQueryCommonSectionsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
  where?: InputMaybe<RootQueryToCommonSectionConnectionWhereArgs>;
};
...
export type RootQueryPublicationArgs = {
  asPreview?: InputMaybe<Scalars['Boolean']>;
  id: Scalars['ID'];
  idType?: InputMaybe<PublicationIdType>;
};


/** The root entry point into the Graph */
export type RootQueryPublicationByArgs = {
  id?: InputMaybe<Scalars['ID']>;
...
/** The root entry point into the Graph */
export type RootQueryPublicationsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
  where?: InputMaybe<RootQueryToPublicationConnectionWhereArgs>;
};
...
/** The root entry point into the Graph */
export type RootQueryTrainingArgs = {
  asPreview?: InputMaybe<Scalars['Boolean']>;
  id: Scalars['ID'];
  idType?: InputMaybe<TrainingIdType>;
};


/** The root entry point into the Graph */
export type RootQueryTrainingByArgs = {
  id?: InputMaybe<Scalars['ID']>;
  slug?: InputMaybe<Scalars['String']>;
...
/** The root entry point into the Graph */
export type RootQueryTrainingsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
  where?: InputMaybe<RootQueryToTrainingConnectionWhereArgs>;
};
...
/** Connection between the RootQuery type and the CommonSection type */
export type RootQueryToCommonSectionConnection = CommonSectionConnection & Connection & {
  __typename?: 'RootQueryToCommonSectionConnection';
  /** Edges for the RootQueryToCommonSectionConnection connection */
  edges: Array<RootQueryToCommonSectionConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<CommonSection>;
  /** Information about pagination in a connection. */
  pageInfo: RootQueryToCommonSectionConnectionPageInfo;
};

/** An edge in a connection */
export type RootQueryToCommonSectionConnectionEdge = CommonSectionConnectionEdge & Edge & {
  __typename?: 'RootQueryToCommonSectionConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']>;
  /** The item at the end of the edge */
  node: CommonSection;
...
/** Page Info on the &quot;RootQueryToCommonSectionConnection&quot; */
export type RootQueryToCommonSectionConnectionPageInfo = CommonSectionConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'RootQueryToCommonSectionConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean'];
...
/** Arguments for filtering the RootQueryToCommonSectionConnection connection */
export type RootQueryToCommonSectionConnectionWhereArgs = {
  /** Filter the connection based on dates */
  dateQuery?: InputMaybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword?: InputMaybe<Scalars['Boolean']>;
...
/** Connection between the RootQuery type and the Publication type */
export type RootQueryToPublicationConnection = Connection & PublicationConnection & {
  __typename?: 'RootQueryToPublicationConnection';
  /** Edges for the RootQueryToPublicationConnection connection */
  edges: Array<RootQueryToPublicationConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Publication>;
  /** Information about pagination in a connection. */
  pageInfo: RootQueryToPublicationConnectionPageInfo;
};

/** An edge in a connection */
export type RootQueryToPublicationConnectionEdge = Edge & PublicationConnectionEdge & {
  __typename?: 'RootQueryToPublicationConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']>;
  /** The item at the end of the edge */
  node: Publication;
...
/** Page Info on the &quot;RootQueryToPublicationConnection&quot; */
export type RootQueryToPublicationConnectionPageInfo = PageInfo & PublicationConnectionPageInfo & WpPageInfo & {
  __typename?: 'RootQueryToPublicationConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean'];
...
/** Arguments for filtering the RootQueryToPublicationConnection connection */
export type RootQueryToPublicationConnectionWhereArgs = {
  /** Filter the connection based on dates */
  dateQuery?: InputMaybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword?: InputMaybe<Scalars['Boolean']>;
...
/** Connection between the RootQuery type and the Training type */
export type RootQueryToTrainingConnection = Connection & TrainingConnection & {
  __typename?: 'RootQueryToTrainingConnection';
  /** Edges for the RootQueryToTrainingConnection connection */
  edges: Array<RootQueryToTrainingConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Training>;
  /** Information about pagination in a connection. */
  pageInfo: RootQueryToTrainingConnectionPageInfo;
};

/** An edge in a connection */
export type RootQueryToTrainingConnectionEdge = Edge & TrainingConnectionEdge & {
  __typename?: 'RootQueryToTrainingConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']>;
  /** The item at the end of the edge */
  node: Training;
...
/** Page Info on the &quot;RootQueryToTrainingConnection&quot; */
export type RootQueryToTrainingConnectionPageInfo = PageInfo & TrainingConnectionPageInfo & WpPageInfo & {
  __typename?: 'RootQueryToTrainingConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean'];
...
/** Arguments for filtering the RootQueryToTrainingConnection connection */
export type RootQueryToTrainingConnectionWhereArgs = {
  /** Filter the connection based on dates */
  dateQuery?: InputMaybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword?: InputMaybe<Scalars['Boolean']>;
...
/** The Training type */
export type Training = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithFeaturedImage & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & {
  __typename?: 'Training';
  /** The content of the post. */
  content?: Maybe<Scalars['String']>;
  /** Connection between the ContentNode type and the ContentType type */
  ...
  /** The global unique identifier for this post. This currently matches the value stored in WP_Post-&gt;guid and the guid column in the &quot;post_objects&quot; database table. */
  guid?: Maybe<Scalars['String']>;
  /** The globally unique identifier of the training object. */
  id: Scalars['ID'];
  /** Whether the node is a Content Node */
  isContentNode: Scalars['Boolean'];
  /** Whether the object is a node in the preview state */
  ...
  /** The GMT modified time for a post. If a post was recently updated the modified field will change to match the corresponding time in GMT. */
  modifiedGmt?: Maybe<Scalars['String']>;
  /** Connection between the Training type and the Training type */
  preview?: Maybe<TrainingToPreviewConnectionEdge>;
  /** The database id of the preview node */
  previewRevisionDatabaseId?: Maybe<Scalars['Int']>;
  /** Whether the object is a node in the preview state */
  previewRevisionId?: Maybe<Scalars['ID']>;
  ...
  /** The title of the post. This is currently just the raw title. An amendment to support rendered title needs to be made. */
  title?: Maybe<Scalars['String']>;
  /** Added to the GraphQL Schema because the ACF Field Group &quot;Тренажер&quot; was set to Show in GraphQL. */
  training?: Maybe<Training_Training>;
  /**
   * The id field matches the WP_Post-&gt;ID field.
   * @deprecated Deprecated in favor of the databaseId field
   */
...
/** The Training type */
export type TrainingEnqueuedScriptsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
/** The Training type */
export type TrainingEnqueuedStylesheetsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
export type TrainingConnection = {
  /** A list of edges (relational context) between RootQuery and connected Training Nodes */
  edges: Array<TrainingConnectionEdge>;
  /** A list of connected Training Nodes */
  nodes: Array<Training>;
  /** Information about pagination in a connection. */
  pageInfo: TrainingConnectionPageInfo;
};

/** Edge between a Node and a connected Training */
export type TrainingConnectionEdge = {
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']>;
...
/** Page Info on the connected TrainingConnectionEdge */
export type TrainingConnectionPageInfo = {
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean'];
...
/** Connection between the Training type and the Training type */
export type TrainingToPreviewConnectionEdge = Edge & OneToOneConnection & TrainingConnectionEdge & {
  __typename?: 'TrainingToPreviewConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']>;
  /** The node of the connection, without the edges */
  node: Training;
...
/** Field Group */
export type Training_Training = AcfFieldGroup & {
  __typename?: 'Training_Training';
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']>;
  nazvanie?: Maybe<Scalars['String']>;
  trainingCzena?: Maybe<Scalars['Float']>;
  trainingImageKompyuter1x?: Maybe<MediaItem>;
  trainingImageKompyuter2x?: Maybe<MediaItem>;
  trainingImageTelefon1x?: Maybe<MediaItem>;
  trainingImageTelefon2x?: Maybe<MediaItem>;
  trainingKratkoeOpisanie?: Maybe<Scalars['String']>;
  trainingPodrobnoeOpisanie?: Maybe<Scalars['String']>;
};
...
/** Input for the updateCommonSection mutation. */
export type UpdateCommonSectionInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']>;
  /** The content of the object */
  content?: InputMaybe<Scalars['String']>;
  /** The date of the object. Preferable to enter as year/month/day (e.g. 01/31/2017) as it will rearrange date as fit if it is not specified. Incomplete dates may have unintended results for example, "2017" as the input will use current date with timestamp 20:17  */
  date?: InputMaybe<Scalars['String']>;
  /** The ID of the CommonSection object */
  id: Scalars['ID'];
  /** Override the edit lock when another user is editing the post */
  ignoreEditLock?: InputMaybe<Scalars['Boolean']>;
  /** A field used for ordering posts. This is typically used with nav menu items or for special ordering of hierarchical content types. */
...
/** The payload for the updateCommonSection mutation. */
export type UpdateCommonSectionPayload = {
  __typename?: 'UpdateCommonSectionPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']>;
  /** The Post object mutation type. */
  commonSection?: Maybe<CommonSection>;
...
/** Input for the updatePublication mutation. */
export type UpdatePublicationInput = {
  ...
  /** The date of the object. Preferable to enter as year/month/day (e.g. 01/31/2017) as it will rearrange date as fit if it is not specified. Incomplete dates may have unintended results for example, "2017" as the input will use current date with timestamp 20:17  */
  date?: InputMaybe<Scalars['String']>;
  /** The ID of the Publication object */
  id: Scalars['ID'];
  /** Override the edit lock when another user is editing the post */
  ignoreEditLock?: InputMaybe<Scalars['Boolean']>;
  /** A field used for ordering posts. This is typically used with nav menu items or for special ordering of hierarchical content types. */
...
/** The payload for the updatePublication mutation. */
...
/** Input for the updateTraining mutation. */
...
/** The payload for the updateTraining mutation. */
export type UpdateTrainingPayload = {
  __typename?: 'UpdateTrainingPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']>;
  /** The Post object mutation type. */
  training?: Maybe<Training>;
